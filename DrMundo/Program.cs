...
namespace MrMundo
{
    internal class Program
    {
        ...
        private static void Loading_OnLoadingComplete(EventArgs args)
        {
            ...
            Menu = MainMenu.AddMenu("DrMundo", "mrmundo");
            ...
            ComboMenu.Add("useRComboHPPercent", new Slider("HP %", 25));
            ...
            HarassMenu.AddLabel("Automatic Harass");
            HarassMenu.Add("autoQ", new CheckBox("Use Q"));
            HarassMenu.AddLabel("Harass");
        ...
        private static void Game_OnTick(EventArgs args)
        {
            ...
            {
                target = TargetSelector.GetTarget(SpellHandler.Q.Range, DamageType.Physical);
