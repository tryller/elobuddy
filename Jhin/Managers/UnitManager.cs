    ...
    public static class UnitManager
    {
        ...
        public static void Initialize()
        {
            Game.OnTick += delegate
            {
                ...
                ValidEnemyHeroesInRange.AddRange(
                    ValidEnemyHeroes.Where(h => Program.MyHero.IsInRange(h, Program.CurrentChampion.Range + h.BoundingRadius)));
                ...
                ValidAllyHeroesInRange.AddRange(
                    ValidAllyHeroes.Where(h => Program.MyHero.IsInRange(h, Program.CurrentChampion.Range + h.BoundingRadius)));
            };
        }
        ...
        public static bool HasIgnite(this AIHeroClient hero)
        {
            return hero.TargetHaveBuff("summonerdot") &&
                   ...
                   Program.MyHero.GetSummonerSpellDamage(hero, DamageLibrary.SummonerSpells.Ignite);
        }
    }
}