...
namespace Jhin.Managers
{
    public static class ModeManager
    {
        ...
        {
            get { return Orbwalker.ActiveModesFlags.HasFlag(Orbwalker.ActiveModes.JungleClear) && EntityManager.MinionsAndMonsters.Monsters.Any(o => Program.MyHero.IsInAutoAttackRange(o)); }
        }
