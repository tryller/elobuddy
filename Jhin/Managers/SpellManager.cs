...
namespace Jhin.Managers
{
    public static class SpellManager
    {
        ...
        {
            Smite = new SpellBase(Program.MyHero.GetSummonerSpellSlot("smite"), SpellType.Targeted, 500);
            Ignite = new SpellBase(Program.MyHero.GetSummonerSpellSlot("summonerdot"), SpellType.Targeted, 600);
            Flash = new SpellBase(Program.MyHero.GetSummonerSpellSlot("flash"), SpellType.Circular, 400) {Width = 100};
            Heal = new SpellBase(Program.MyHero.GetSummonerSpellSlot("heal"), SpellType.Self);
        }
        ...
        {
            return Program.MyHero.Spellbook.GetSpell(slot);
        }
    }
}