...
namespace Jhin.Managers
{
    ...
    public static class MenuManager
    {
        ...
        {
            Menu = MainMenu.AddMenu("Jhin", "Jhin Build: 6.7.0, Champion: " + Program.MyHero.ChampionName);
        ...
        public static void AddDrawingsMenu()
        {
            ...
            CircleManager.Circles.Add(new Circle(menu.AddValue("Target", new CheckBox("Draw circle on target")),
                new ColorBGRA(255, 0, 0, 100), () => 120f, () => Program.CurrentChampion.Target != null,
                () => Program.CurrentChampion.Target) {Width = 5});
            menu.AddSeparator();
        }
        ...
        {
            return m != null && Program.CurrentChampion != null && Program.Initialized && m[s].Cast<CheckBox>().CurrentValue;
        }

        public static bool KeyBind(this Menu m, string s)
        {
            return m != null && Program.CurrentChampion != null && Program.Initialized && m[s].Cast<KeyBind>().CurrentValue;
        }
    }
}